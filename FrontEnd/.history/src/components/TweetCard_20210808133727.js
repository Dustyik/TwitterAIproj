...
const TweetCard = (props) => {
    ...
    const createCheckBoxes = () => {
        ...
        const firstNumber = retweetNumber + Math.floor(Math.random() * 10);
        const firstNumber = retweetNumber - Math.floor(Math.random() * 4);
        const firstNumber = retweetNumber - Math.floor(Math.random() * 2);
