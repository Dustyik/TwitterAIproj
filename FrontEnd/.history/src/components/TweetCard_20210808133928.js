...
const TweetCard = (props) => {
    ...
    const generateFourNumbers = (retweetNumber) => {
        const firstNumber = Math.abs(retweetNumber + Math.floor(Math.random() * 5))
        const secondNumber = Math.abs(retweetNumber + Math.floor(Math.random() * 10))
        const thirdNumber = Math.abs(retweetNumber - Math.floor(Math.random() * 4))
        const fourthNumber = Math.abs(retweetNumber - Math.floor(Math.random() * 2))
    ...
    const createCheckBoxes = () => {
        ...
        numbersArray = generateFourNumbers(retweetNumber)
