...
export const TrendsList = () => {
    const { humanPredictionDifference, modelPredictionDifference, addHumanPredictionDifference,addModelPredictionDifference } = useContext(GlobalContext);
    ...
    const trends = [
        {
            ...
            tweets: {humanPredictionDifference}
        },
        {
