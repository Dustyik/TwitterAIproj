...
const TweetCard = (props) => {
    ...
    const createCheckBoxes = () => {
        ...
        const firstNumber = retweetNumber + Math.floor(Math.random() * 5);
        const secondNumber = retweetNumber + Math.floor(Math.random() * 10);
        const thirdNumber = retweetNumber - Math.floor(Math.random() * 4);
        const fourthNumber = retweetNumber - Math.floor(Math.random() * 2);
