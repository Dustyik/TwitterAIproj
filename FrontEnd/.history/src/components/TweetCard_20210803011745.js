            ...
            <div className="tweet-card">
                ...
                <div className="right">
                    ...
                    <div>
                        ...
                        <div className="tweet-meta-information">
                            <span>Followers: {this.tweet.followers}</span>
                        
                            <span style = {{marginLeft:10}}>Friends: {this.tweet.friends}</span>
                        </div>
                        <div className="tweet-meta-information">
                            <span>Hashtags: {this.tweet.hashtags}</span>
                        </div>
                        <div className="tweet-meta-information">
                            <span>Mentions: {this.tweet.mentions}:</span>
                        </div>
                        <div className="tweet-meta-information">
                            {this.props.returnRenderUrls(this.tweet)}
                        </div>
