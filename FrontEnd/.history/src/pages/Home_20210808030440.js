...
export const Home = () => {
    const { setTweets, removeAllTweets, modalOpen, getModalState } = useContext(GlobalContext);
    ...
    return (
        <div>
            ...
            <Modal title="Basic Modal" visible={getModalState()} onOk={handleOk} onCancel={handleCancel}>
            <p>Some contents...</p>
            <p>Some contents...</p>
            <p>Some contents...</p>
        </Modal>
