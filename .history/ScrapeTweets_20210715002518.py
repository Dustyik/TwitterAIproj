...
df = pd.read_csv(r'D:\Desktop\AI_term_8\twitter\TweetsCOV19_3.tsv', sep='\t',header=None, error_bad_lines=False, names = ['Tweet Id', 'Username','Timestamp','Followers','Friends','Retweets','Favourites','Entities','Sentiment','Mentions','Hashtags','URLS'])
df = df.iloc[:100]
df.head()
