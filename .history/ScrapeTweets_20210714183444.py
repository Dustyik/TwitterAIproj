...
df = pd.read_csv(r'C:\Users\Chia Yik\OneDrive\Desktop\TweetsCOV19pull.xlsx', names=['TweetId', 'Username','Timestamp','Followers','Friends','Retweets','Favourites','Entities','Sentiment','Mentions','Hashtags','URLS'], error_bad_lines=False, engine='python')
