...
df = pd.read_csv(r'D:\Desktop\AI_term_8\twitter\TweetsCOV19pull.xlsx', names=['TweetId', 'Username','Timestamp','Followers','Friends','Retweets','Favourites','Entities','Sentiment','Mentions','Hashtags','URLS'], error_bad_lines=False)
