...
const TweetCard = (props) => {
    ...
    const { toggleWinModal, toggleLoseModal,setCurrentTweet} = useContext(GlobalContext);
        ...
        <div className="tweet-card">
            ...
            <div className="right">
                ...
                <div>
                    ...
                    <div className="tweet-meta-information">
                        <span className="tweet-meta-information-inner" >Positive Sentiment: {tweet.positiveSentiment}</span>
                    </div>
                    <div className="tweet-meta-information">
                        <span className="tweet-meta-information-inner" >Negative Sentiment: {tweet.negativeSentiment}</span>
                    </div>
                    <div className="tweet-meta-information">
