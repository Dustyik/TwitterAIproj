...
export const Home = () => {
    const { removeTweet, guess, setTweets, removeAllTweets, winModalOpen, toggleWinModal, loseModalOpen, toggleLoseModal, currentTweet, tweets } = useContext(GlobalContext);
    ...
    const handleWinCancel = () => {
        ...
        toggleWinModal()
        console.log("After filter", tweets)
    };
    ...
    useEffect(() => {
        console.log("use effect", currentTweet)
        if(!currentTweet){
    
        }else{
            setModelPredictions(currentTweet.modelRetweetPredictions) 
            setCorrectRetweetValue(currentTweet.tweet.retweets)
            setCurrentTweetKey(currentTweet.key)
            console.log("SET VALUE", modelPredictions, correctRetweetValue)
    ...
    return (
        <div>
            ...
            <div style = {{padding:10, display:"flex", flexDirection:"column", alignItems:"center"}}>
                ...
                {console.log(modelPredictions, correctRetweetValue)}
                <h3>
