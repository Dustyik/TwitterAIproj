...
export const Home = () => {
    ...
    var modelPredictions, correctRetweetValue

    useEffect(() => {
        console.log("use effect", currentTweet)
        if(!currentTweet){
            modelPredictions = "loading"
            correctRetweetValue = "loading"
        }else{
            modelPredictions = currentTweet.modelRetweetPredictions 
            correctRetweetValue = currentTweet.tweet.retweets
